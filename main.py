...
START_IMG = "https://i.imghippo.com/files/gYgS5690X.jpg"

STKR = "CAACAgQAAxkBAAEN6QABZ8CdoZaf0mL5i11zH5VmSYoDaf4AAsAZAALXmAlSu7vBGh879YY2BA"
...
START =f"""
**๏🍃ʜᴇʏ, ɪ ᴀᴍ {BOT_NAME}**
**❤️‍🔥ᴀɴ ᴀɪ-ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ.**
**♡━━━━━━━━ ᴀʀɪ ━━━━━━━♡**
**➻ ᴜsᴀɢᴇ /chatbot [on/off]**
**๏ ᴛᴏ ɢᴇᴛ ʜᴇʟᴘ ᴜsᴇ /help**
**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ || [ᴀʀɪ](https://t.me/xazoc)||**
"""
SOURCE_TEXT = f"""
**๏ ʜᴇʏ, ɪ ᴀᴍ [{BOT_NAME}]
➻ ᴀɴ ᴀɪ-ʙᴀsᴇᴅ ᴄʜᴀᴛʙᴏᴛ.
...
"""
SOURCE_BUTTONS = InlineKeyboardMarkup([[InlineKeyboardButton('❤️‍🔥sᴏᴜʀᴄᴇ❤️‍🔥', callback_data='hurr')], [InlineKeyboardButton("❤️‍🔥ꜱᴜᴘᴘᴏʀᴛ❤️‍🔥", url=f"https://t.me/{SUPPORT_GRP}"), InlineKeyboardButton(text="ʙᴀᴄᴋ ", callback_data="HELP_BACK")]])
SOURCE = 'https://t.me/your_support_channel'
x=["❤️","🥰","✨","💖","🎉","❤️‍🔥","💫"]
g=choice(x)
...
MAIN = [
    [
        InlineKeyboardButton(text="❤️‍🔥ᴅᴇᴠᴇʟᴏᴘᴇʀ❤️‍🔥", url=f"https://t.me/{OWNER_USERNAME}"),
            ...
            try:
                await msg.reply_photo(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton("🍃ᴄʜᴀɴɴᴇʟ🍃", url=link),
                            ]
                        ]
                    )
                )
...
async def restart(client, m: Message):
        ...
        await accha.edit("ᴘɪɴɢ ᴘᴏɴɢ ꜱᴛᴀʀᴛɪɴɢ..❤️‍🔥")
...
async def ping(client, message: Message):
        ...
        await message.reply_photo(
                             photo=START_IMG,
                             caption=f"ʜᴇʏ ʙᴀʙʏ!!\n**[{BOT_NAME}](t.me/{BOT_USERNAME})** ɪꜱ ᴀʟɪᴠᴇ 💖❤️‍🔥 ᴀɴᴅ ᴡᴏʀᴋɪɴɢ ꜰɪɴᴇ ᴡɪᴛʜ ᴘᴏɴɢ ᴏꜰ \n➥ `{ms}` ms\n\n**ᴍᴀᴅᴇ ᴡɪᴛʜ ❣️ ʙʏ || [ᴀʀɪ](https://t.me/xazoc)||**",
